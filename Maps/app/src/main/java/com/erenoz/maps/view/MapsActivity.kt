...
import com.erenoz.maps.databinding.ActivityMapsBinding
...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback, GoogleMap.OnMapLongClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
     ...
     setContentView(binding.root)
        ...
        sharedPreferences = this.getSharedPreferences("com.erenoz.maps" , MODE_PRIVATE)
        trackBoolean = false
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        if (info == "new") {
            ...
            binding.deleteButton.visibility = View.GONE // görünmez ve o alanı kaplar.
    ...
    fun handleResponse() { //save fonksiyonundan sonra ne olacak
